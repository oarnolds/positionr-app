...
export default async function ICPVolledigProfielPage({
  params,
}: {
  ...
  return (
    <div className="rounded-2xl border-2 border-dashed border-cyan-200 bg-cyan-50 p-12 text-center">
      ...
      <p className="mt-4 text-sm text-cyan-900">
        ICP-profiel wordt gegenereerd... pagina ververst zich automatisch.
      </p>
...
function FailedState({
  ...
  return (
    <div className="rounded-2xl border border-red-200 bg-red-50 p-6">
      <h2 className="text-lg font-bold text-red-900">Generatie mislukt</h2>
      <p className="mt-2 text-sm text-red-800">{message}</p>
      <Link
        href={`/modules/icp-analyse/${productId}/volledig/${sessionId}/webform`}
